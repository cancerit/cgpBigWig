...
int process_bam_file(char *input_file, bw_func func, tmpstruct_t *tmp, int filter, int filter_inc, char *ref);

int process_bam_region(char *input_file, bw_func_reg func, tmpstruct_t *tmp, int filter, int filter_inc, char *region, char *ref);

int process_bam_region_bases(char *input_file, bw_func_reg func, tmpstruct_t *tmp, int filter, int filter_inc, char *region, char *ref);
